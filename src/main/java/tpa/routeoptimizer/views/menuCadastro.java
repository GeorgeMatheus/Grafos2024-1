...
public class menuCadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        calcDistButton.setText("Calcular Distância");
        ...
        calcDistanceAGM.setText("Calcular Distância AGM");
        ...
        saveGraphButton.setText("Salvar arquivos");
    ...
    private void uploadFileButtonMouseClicked(java.awt.event.MouseEvent evt) {
        if (grafo.checkIsEmpty()) {
            ...
            if (!file.exists()) {
                JOptionPane.showMessageDialog(null, "Arquivo não encontrado: " + relativePath);
                return;
            }
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(absolutePath))) {
                ...
                // Lendo a matriz de adjacência e adicionando arestas ao grafo
                for (int i = 0; i < numCidades; i++) {
                    String[] valores = reader.readLine().split(",");
                    for (int j = 0; j < numCidades; j++) {
                        float distancia = Float.parseFloat(valores[j].trim());
                        if (distancia > 0) {
                ...
                feedbackLabel.setText("Grafo carregado com sucesso!");
                graphVizualizeField.setVisible(true);
...
//    }//GEN-LAST:event_saveGraphButtonMouseClicked
    ...
    private void saveGraphButtonMouseClicked(java.awt.event.MouseEvent evt) {
        String relativePath = "src" + File.separator;

        String completeGraphFile = relativePath + "grafoCompleto.txt";
        String agmFile = relativePath + "agm.txt";

        try {
            // Escreve o grafo completo
            writeGraphToFile(completeGraphFile, grafo);

//            // Calcula a árvore geradora mínima (AGM)
//            Grafo<String> agm = grafo.calcularAGM();
//

            feedbackLabel.setText("Grafo e AGM salvos com sucesso!");
        } catch (IOException e) {
            feedbackLabel.setText("Ocorreu um erro ao salvar os arquivos.");
        }
    }

    private void writeGraphToFile(String filePath, Grafo<String> grafo) throws IOException {
        ArrayList<String> vertices = grafo.obterVerticesValues();
        int numCidades = vertices.size();
